...
class CombustionReport extends Component {
  ...
  addItem(e) {
    ...
    var selectedCar = this.props.cars.filter(function(x) {
      return x.key === value;
    });
  ...
  validateForm() {
    this.setState({
      formValid:
        this.state.routeKilometersValid &&
        this.state.routeKilometersValid &&
        this.state.averageSpeedValid
    });
  }
          ...
          <form role="form" onSubmit={this.addItem}>
            ...
            <div className="form-group">
              <input
                ...
                className={`form-control ${this.errorFuelTypeClass(
                  this.state.averageCombusitonValid
                )}`}
