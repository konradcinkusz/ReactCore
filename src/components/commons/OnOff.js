//https://github.com/SergioCrisostomo/react-onoff-switch
...
export default class OnOff extends React.Component {
  ...
  onPointerDown(e) {
    stopEvent(e);
    this.touchDown =
      this.getPointerCoords(e.nativeEvent) - parseInt(e.target.style.left, 10);
  ...
  onDragEnd(e) {
    ...
    const newState = this.dragged
      ? this.state.buttonPosition > 0.2
      : !this.state.on;
    ...
    const button = setStyles(
      {
        ...
        boxShadow: `inset 0 0 0 1px ${
          on ? this.state.activeColor : grey
        }, 0 2px 4px ${grey}`,
